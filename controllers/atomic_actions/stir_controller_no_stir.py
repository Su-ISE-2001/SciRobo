...
class StirControllerNoStir(BaseController):
    """
    搅拌控制器，模拟夹取了玻璃棒但没有执行搅拌动作的异常情况。
    机器人在夹取玻璃棒后，移动到烧杯上方，但不执行搅拌动作，直接完成。
    ...
    def get_no_stir_info(self):
        ...
        if self._exception_fired and not self._exception_reported:
            ...
            info = {
                "type": "no_stir",
                "message": "Picked glass rod but did not stir",
                "suffix": "erro",
                "color": (0, 0, 255),
            }
            return info
